        ...
        setContent {
            ComposeQuadrantTheme {
                ...
                Surface(
                    ...
                    Quadrant("one","two", Color(0xFFEADDFF))
                }
            }
        }
    }
    ...
    Column(Modifier.fillMaxWidth()) {
        Row(Modifier.weight(1f)) {
            Quadrant(
                ...
                content = stringResource(R.string.q1_content),
                myColor = Color(0xFFEADDFF),
                modifier = Modifier.weight(1f)
            )
            Quadrant(
                title = stringResource(R.string.q2_title),
                content = stringResource(R.string.q2_content),
        ...
        Row(Modifier.weight(1f))  {
            Quadrant(
                ...
                content = stringResource(R.string.q3_content),
                myColor = Color(0xFFB69DF8),
                modifier = Modifier.weight(1f)
            )
            Quadrant(
                title = stringResource(R.string.q4_title),
                content = stringResource(R.string.q4_content),
